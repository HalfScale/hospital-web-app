...
import com.muffin.model.dto.AppointmentRequest;
import com.muffin.service.AppointmentService;
...
public class AppointmentController {
    ...
    public ResponseEntity<Object> findAll(@RequestParam(required = false) String appointmentId,
        ...
        return appointmentService.findAll(appointmentId, username, pageable);
    }
