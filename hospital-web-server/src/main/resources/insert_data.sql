...
WITH ins_doctor1 AS (
    INSERT INTO users (email, password, enabled, is_confirmed, user_type, deleted)
    VALUES ('joefazer@gmail.com', '$2a$10$rfN6Z9FD.lUmDLgDfgKKBOKU89rb3KFR0Kytd9hkVLTKqDz4XQGs2', true, true, 2, false)
    RETURNING id
...
WITH ins_doctor2 AS (
    INSERT INTO users (email, password, enabled, is_confirmed, user_type, deleted)
    VALUES ('janedoe@gmail.com', '$2a$10$rfN6Z9FD.lUmDLgDfgKKBOKU89rb3KFR0Kytd9hkVLTKqDz4XQGs2', true, true, 2, false)
    RETURNING id
...
WITH ins_patient1 AS (
    INSERT INTO users (email, password, enabled, is_confirmed, user_type, deleted)
    VALUES ('patrick@gmail.com', '$2a$10$rfN6Z9FD.lUmDLgDfgKKBOKU89rb3KFR0Kytd9hkVLTKqDz4XQGs2', true, true, 3, false)
    RETURNING id
...
WITH ins_patient2 AS (
    INSERT INTO users (email, password, enabled, is_confirmed, user_type, deleted)
    VALUES ('monica@gmail.com', '$2a$10$rfN6Z9FD.lUmDLgDfgKKBOKU89rb3KFR0Kytd9hkVLTKqDz4XQGs2', true, true, 3, false)
    RETURNING id
